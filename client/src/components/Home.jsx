...
export default function Home(){
    ...
    return (
        <div className="container-home">
            ...
            <div>
                <select className="selectStyle" onChange={e => handleSortName(e)}>
                    <option>ALPHABETIC ORDER</option>
                    <option value="asc">Ascendant</option>
                    <option value="desc">Descendant</option>
                </select>   
                <select className="selectStyle" onChange={e => handleSortRating(e)}>
                ...
                <select className="selectStyle" onChange={(e) => handleFilterGenres(e)}> 
